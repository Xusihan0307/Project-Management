...
public class GenerateReporter implements IReporter {
    ...
    public void generateReport(List<XmlSuite> xmlSuites, List<ISuite> suites,
        ...
        try {
            ...
            // 输出流
            OutputStream out=new FileOutputStream("E:\\bookstore-master\\report\\testReport.html");
            Writer writer = new BufferedWriter(new OutputStreamWriter(out,"utf-8"));//解决乱码问题
            // 转换输出
            temp.process(context,writer);
            writer.flush();

            InputStream inputStream = new FileInputStream("E:\\bookstore-master\\report\\testReport.html");
